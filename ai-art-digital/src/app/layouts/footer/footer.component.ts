...
@Component({
  ...
  template: `
    <footer class="bg-slate-900 dark:bg-gradient-to-br dark:from-midnight-950 dark:to-midnight-900 text-white py-12 border-t border-slate-800 dark:border-violet-500/20 section-divider">
      <div class="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div [class]="brandColumnClass">
            ...
            <p class="text-slate-300 dark:text-slate-400 leading-relaxed mb-6 max-w-sm">
              {{ brandDescription() }}
            </p>
            ...
            <div class="flex space-x-4">
              <a
                ...
                target="_blank"
                class="w-10 h-10 glass hover:bg-slate-700 dark:hover:bg-violet-500/20 rounded-lg flex items-center justify-center transition-colors pulse-glow"
          ...
          <div class="md:text-center">
            ...
            <ul class="space-y-2">
              <li *ngFor="let item of navigationItems()">
                <a
                  [href]="'#' + item.anchor"
                  class="text-slate-300 dark:text-slate-400 hover:text-white dark:hover:text-violet-300 transition-colors">
                  {{ item.label }}
                </a>
              </li>
            </ul>
          ...
          <div [class]="contactColumnClass">
            ...
            <div class="space-y-3 text-slate-300 dark:text-slate-400">
              <div class="flex items-center glass px-3 py-2 rounded-lg pulse-glow">
        ...
        <!-- Bottom Section -->
        <div class="mt-12 pt-8 border-t border-slate-800 dark:border-violet-500/20 section-divider flex flex-col md:flex-row justify-between items-center">
          ...
          <div class="mt-4 md:mt-0 flex items-center space-x-4 text-slate-400 dark:text-slate-500 text-sm">
            <a href="#" class="hover:text-white dark:hover:text-violet-300 transition-colors">{{ privacyText() }}</a>
            <span>•</span>
            <a href="#" class="hover:text-white dark:hover:text-violet-300 transition-colors">{{ termsText() }}</a>
          </div>
        </div>
      </div>
    </footer>
